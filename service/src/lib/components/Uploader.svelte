...
{#if set_file === null}
    <div class="h-48 w-80 flex flex-col shadow-xl rounded-xl m-auto mt-20 border-2 border-gray-500 hover:border-orange-600">
      <input accept=".mov, .mp4" hidden id="files" type="file" bind:files={set_file}>
      <p class="text-center font-semibold text-xl text-gray-500 mt-8">Загрузить новый файл</p>
      <label for="files">
